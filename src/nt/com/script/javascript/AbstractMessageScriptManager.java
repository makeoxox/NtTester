...
package nt.com.script.javascript;
...
public abstract class AbstractMessageScriptManager {
	...
	protected void loadLib() {
		...
		if (engine == null) {
			...
			try {
				engine.eval(new InputStreamReader(AbstractMessageScriptManager.class.getResourceAsStream("/nt/com/script/javascript/h.js")));
			} catch (Exception e) {
